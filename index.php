...
<div class="session">
    <div class="container">
        <div class="row text-center justify-content-center">
            <div class="col-md-10">
                <h1 class="font-primary font-bold color-black">Nós temos um investimento que tem tudo a ver com você!</h1>
                <p class="font-paragraph color-black m-4">Na Axial Investimentos você nunca está sozinho.  Nossa equipe vai encontrar os melhores investimentos de acordo com seu perfil e o seu desejo futuro.</p>
                <p class="font-default font-bold color-black">Veja abaixo os serviços que preparamos para você.</p>
            </div>
        </div>
        ...
        <div class="row align-items-center gx-5 mt-5">
            ...
            <div class="col-md-7">
                ...
                <p class="font-paragraph color-black mt-4">A Axial Investimentos está pronta para entender qual é seu perfil como investidor e te assessorar com as melhores opções de investimento do mercado, visando maximizar seus ganhos.</p>
                <a href="solucoes.php" class="btn btn-primary">Descubra seu melhor investimento</a>
            </div>
        </div>
...
<div class="session-img bg-primary">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-7">
                <h2 class="font-secondary color-light">Trabalhamos com a corretora que mais cresce, <span class="font-bold">ModalMais</span></h2>
                <p class="font-paragraph color-light mt-4">O Credit Suisse e o Banco Modal se uniram em uma parceria, possibilitando a distribuição de produtos do Credit Suisse, como notas, fundos, operações de crédito, ofertas de ações, dentre outros.</p>
...
<div class="session">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="font-primary font-bold color-black">Quem somos nós?</h1>
